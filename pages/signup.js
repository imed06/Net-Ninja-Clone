                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <div className="text-sm  text-black dark:text-gray-400 text-center">
                                Already have an accound? <span className=" text-red-500">Log in</span>
                            </div>
                            <h1 className="text-4xl tracking-wider text-center font-bold leading-tight  text-gray-900">
                                Sign up
                            </h1>
                                
                                    <button type="submit" className="w-full text-white bg-[#D91B42] font-medium rounded-full text-xl px-4 py-4 text-center">Sign up with Email</button>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 text-sm">
                                        <label htmlFor="remember" className="text-black">Yes, Net Ninja can email me with promotions and news. (optional)</label>
                                    </div>
                                </div>
                                <div className="text-sm  text-black dark:text-gray-400 text-center">
                                    By signing up, I agree to Net Ninja's <span className=" text-red-500">Terms of Use </span>& <span className=" text-red-500">Privacy Policy</span>, and the <span className=" text-red-500">Terms of Use </span>& <span className=" text-red-500">Privacy Policy</span> of the learning platform
                                </div>
                        </div>
                    </div>
                </div>
