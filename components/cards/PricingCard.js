const PricingCard = () => {
    return (
        <div className="flex flex-col  max-w-sm  text-gray-900 rounded-sm border-4 border-solid border-[#c39a3a] shadow bg-[#333333]">
            <div className='flex items-center text-center flex-col p-24 py-16 pb-0' >
                <h3 className="mb-4 text-3xl font-semibold text-white">Monthly<br></br> Membership</h3>
                <div className="flex justify-center items-baseline my-8 text-white border-b border-gray-100/10 pb-8 space-x-5">
                    ...
                    <span className="mx-2 text-6xl font-extrabold">$9</span>
